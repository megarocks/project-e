...
!function () {
    ...
    if (g)return g;
    if ("file" === jQuery(b).attr("type") && (f = f.replace(/\*/g, ".*"), b.files && b.files.length))for (d = 0; d < b.files.length; d++)if (e = b.files[d], !e.type.match(new RegExp(".?(" + f + ")$", "i")))return!1;
    return!0
    ...
    var d = $(c[1], b.form), e = d.eq(0), f = e.data("valid_skip") ? e.data("valid_skip") : $.extend({}, this), g = d.filter(function () {
        return f.elementValue(this)
    }).length, h = 0 === g || g >= c[0];
