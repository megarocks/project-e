    ...
    var i = function (t, i) {
        ...
        c.on(ace.click_event, function (t) {
            ...
            if ("number" == typeof i) {
                ...
                if (i = l.indexOf(s), -1 == i && n === !0 && (l.push(s), e("<option />").appendTo(a).val(s), e('<li><a class="colorpick-btn" href="#"></a></li>').appendTo(c).find("a").css("background-color", s).data("color", s), i = l.length - 1), -1 == i)return;
    ...
    r.error = {FILE_LOAD_FAILED: 1, IMAGE_LOAD_FAILED: 2, THUMBNAIL_FAILED: 3}, r.prototype.apply_settings = function () {
        ...
        if (i && 0 != i.length) {
            ...
            for (var n = 0; n < i.length; n++) {
                ...
                } else this.$label.find(".ace-file-name").attr({"data-title": s}).find(ace.vars[".icon"]).attr("class", ace.vars.icon + o)
            }
            return!0
        }
    ...
    e.fn.ace_wysiwyg = function (t) {
        ...
        return this.each(function () {
            ...
            t.find("a[data-view=source]").on("click", function (t) {
                ...
                } else e("<textarea />").css({width: u.outerWidth(), height: u.outerHeight()}).val(u.html()).insertAfter(u), u.hide(), e(this).addClass("active");
                f = !f
            });
