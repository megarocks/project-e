...
!function (c) {
    ...
    b.prototype = {constructor: b, show: function () {
        ...
        }).typeahead({source: d.options.source, matcher: function (e) {
        ...
        var d = this;
        c("<span/>", {"class": "tag"}).text(e).append(c('<button type="button" class="close">&times;</button>').on("click", function () {
    ...
    c.fn.tag = function (d) {
        return this.each(function () {
            var f = c(this), g = f.data("tag"), e = typeof d == "object" && d;
            if (!g) {
    ...
    c.fn.tag.defaults = {allowDuplicates: false, caseInsensitive: true, placeholder: "", source: []};
