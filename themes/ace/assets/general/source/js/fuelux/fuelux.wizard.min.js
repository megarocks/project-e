...
(function (c, d) {
    ...
    b.prototype = {constructor: b, setState: function () {
        ...
        if (f) {
            ...
            this.$element.trigger(h, {step: i + 1});
        ...
        if (f) {
            ...
            this.$element.trigger(g, {step: this.currentStep, direction: "previous"});
        ...
        if (h) {
            var g = c.Event("change");
            this.$element.trigger(g, {step: this.currentStep, direction: "next"});
            if (g.isDefaultPrevented()) {
                return
            }
            this.currentStep += 1;
    ...
    c.fn.wizard.defaults = {selectedItem: {step: 1}};
